                    ...
                    <form method="POST" action="{{ route('profile.update', $user->user_id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 d-flex flex-column align-items-center justify-content-center">
                                <!-- Gambar Profil -->
                                <img id="profile-pic" src="{{ $user->avatar ? asset('storage/photos/' . $user->avatar) : asset('img/pp.jpg') }}" class="img-thumbnail mb-3" width="220" height="220" alt="Profile Picture">
